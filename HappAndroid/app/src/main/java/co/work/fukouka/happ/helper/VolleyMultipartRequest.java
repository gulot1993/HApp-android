...
public class VolleyMultipartRequest extends Request<NetworkResponse> {
    //private static final String URL = "http://happ.biz/wp-admin/admin-ajax.php";
     ...
     */
    public VolleyMultipartRequest(int method, Response.Listener<NetworkResponse> listener,
                                  Response.ErrorListener errorListener) {
